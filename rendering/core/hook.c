...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/02/21 18:15:34 by user42            #+#    #+#             */
/*   Updated: 2021/02/21 18:15:56 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	register_hook(t_game *game)
{
	if (game->settings.bmp_required == 0)
	{
		...
		mlx_hook(game->render.win, 02, 1L << 0, set_move,
		&game->render.moves);
		mlx_hook(game->render.win, 03, 1L << 1, unset_move,
		&game->render.moves);
